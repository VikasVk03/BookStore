  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>Whether you're a student chasing knowledge, a passionate reader hunting for your next favorite story, or someone looking to declutter your bookshelf — you're in the right place.</p>
